...
// В консоли виден результат, механики, которые не соответствуют типу автомобиля, не добавляются, вместо этого выдается комментарий, что нельзя добавить данного механика к автомобилю.
        ...
        //Вызов метода "Починить машину". Если водитель допущен к авто, то есть был ранее добавлен к автомобилю, то может отремонтировать, если же нет, то выдаст соответсвующее сообщение.
        System.out.println();
